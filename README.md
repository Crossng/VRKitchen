...
- Gameplay loop: Chinese order feedback, validated plate submission, pan/stove cooking, overcooked burnt food rejection, 3-minute session timer, score target, streak bonus, mission clear result, star rating, correct/wrong counters, progressive burger and garden salad orders, dynamic stage hints, urgency text, and next-goal guidance.
